...
def forgot_password(request):
    ...
    body = "you password reset link is:{link}".format(link=link)
    send_mail(
        "Password reset from our webstore",
        body,
        "webstore@gmail.com",
        [data['email']]
    )
...
#def Profile_Detail_api(request,id):
   # ProfileDetail = Profile.objects.get(id=id)
     #data = ProfileSerializers(ProfileDetail).data
